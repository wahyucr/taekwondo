                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="nik"
                            value="{{ old('nik', $pendaftaran->nik) }}" disabled>
                        @error('nik')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nm_lengkap"
                            value="{{ old('nm_lengkap', $pendaftaran->nm_lengkap) }}" disabled>
                        @error('nm_lengkap')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="j_kelamin" class="form-control" disabled>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tmpt_lahir"
                                    value="{{ old('tmpt_lahir', $pendaftaran->tmpt_lahir) }}" disabled>
                                @error('tmpt_lahir')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tgl_lahir"
                                    value="{{ old('tgl_lahir', $pendaftaran->tgl_lahir) }}" disabled>
                                @error('tgl_lahir')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="usia"
                                        value="{{ old('usia', $pendaftaran->usia) }}" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="berat_badan"
                                        value="{{ old('berat_badan', $pendaftaran->berat_badan) }}" disabled>
                                    <div class="input-group-append">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="tinggi_badan"
                                        value="{{ old('tinggi_badan', $pendaftaran->tinggi_badan) }}" disabled>
                                    <div class="input-group-append">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="gol_darah"
                                    value="{{ old('gol_darah', $pendaftaran->gol_darah) }}" disabled>
                                @error('gol_darah')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tmpt_dojang"
                            value="{{ old('tmpt_dojang', $pendaftaran->tmpt_dojang) }}" disabled>
                        @error('tmpt_dojang')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
